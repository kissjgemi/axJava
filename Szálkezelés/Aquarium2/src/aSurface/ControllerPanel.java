...
public class ControllerPanel extends javax.swing.JPanel {
    ...
    DefaultListModel<Object> fishListModel = new DefaultListModel<>();
    ...
    public void listFishes(List<Object> objectList) {
        fishListModel.clear();
        for (Object o : objectList) {
            fishListModel.addElement(o);
        }
    }
    ...
    private void initComponents() {
        ...
        listFishes.setModel(new javax.swing.AbstractListModel<Object>() {
            Object[] f = {};
            public int getSize() { return f.length; }
            public Object getElementAt(int i) { return f[i]; }
        });
    ...
    private void btnSelectionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectionActionPerformed
        List<Object> objects = listFishes.getSelectedValuesList();
        for (Object o : objects) {
            c.objectProcessing(o);
            fishListModel.removeElement(o);
        }
    ...
    private javax.swing.JList<Object> listFishes;
