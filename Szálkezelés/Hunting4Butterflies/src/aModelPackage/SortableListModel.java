...
/**
 * Saját, rendezhető listamodell. Bármely Comparable típusra alkalmazható.
 *
 * @param <T>
 */
public class SortableListModel<T extends Comparable<T>>
    ...
    /**
     * Ha utólag akarjuk rendezni a modellt, akkor ezt a metódust kell hívni.
     * (Látható, hogy használható a lista-rendezés.) A rendezés után jelzi, hogy
     * megváltozott a tartalma, ezt a hozzárendelt JList kezeli majd.
     */
    public void sort() {
    ...
    public List<T> getModell() {
        List<T> list = new ArrayList<>();
        for (int ii = 0; ii < modell.size(); ii++) {
            list.add((T) modell.get(ii));
        }
        return list;
    }
    ...
    public String toString() {
        return super.toString() + pointtext;
    }
}
