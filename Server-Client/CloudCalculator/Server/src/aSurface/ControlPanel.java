...
public class ControlPanel extends javax.swing.JPanel {
    ...
    private final DefaultListModel<CB6User> userListModel;
    ...
    public void fillUserList(List<CB6User> list) {
        userListModel.clear();
    ...
    private void initComponents() {
        ...
        lstUser.setModel(new javax.swing.AbstractListModel<aBasis.CB6User>() {
            aBasis.CB6User[] u = {  };
            public int getSize() { return u.length; }
            public aBasis.CB6User getElementAt(int i) { return u[i]; }
        });
    ...
    private javax.swing.JList<aBasis.CB6User> lstUser;
