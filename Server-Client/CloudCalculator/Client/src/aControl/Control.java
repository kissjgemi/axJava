...
public class Control {
    ...
    private List<CB6Client> clientList;

    public List<CB6Client> getClientList() {
        return clientList;
    }

    private CB6Client mb6Client;
    ...
    public void connect(String ip, String port, String user) {
        ...
        userName = user;
        mb6Client = new CB6Client(serverIP, serverPort, userName, "hu");
    ...
    public void clientClosed(CB6Client client) {
        clientList.remove(client);
    }

    public void closeClients() {
        for (CB6Client client : clientList) {
