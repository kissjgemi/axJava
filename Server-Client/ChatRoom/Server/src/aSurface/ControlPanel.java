...
public class ControlPanel extends javax.swing.JPanel {
    ...
    private final DefaultListModel<ChatUser> userListModel;
    ...
    public void fillUserList(List<ChatUser> list) {
        userListModel.clear();
    ...
    private void initComponents() {
        ...
        lstUser.setModel(new javax.swing.AbstractListModel<aBasis.ChatUser>() {
            aBasis.ChatUser[] u = {  };
            public int getSize() { return u.length; }
            public aBasis.ChatUser getElementAt(int i) { return u[i]; }
        });
    ...
    private javax.swing.JList<aBasis.ChatUser> lstUser;
