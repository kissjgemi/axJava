...
public class Control {
    ...
    public List<ChatClient> getClientList() {
        return clientList;
    }

    private ChatClient mb6Client;
    ...
    public void connect(String ip, String port, String user) {
        ...
        userName = user;
        mb6Client = new ChatClient(serverIP, serverPort, userName, "hu");
    ...
    public void clientClosed(ChatClient client) {
