        ...
        switch (state) {
            ...
            default: {
                g.drawImage(mainImage, 0, 0,
                        this.getWidth(), this.getHeight(), this);
                g.drawLine(0, GOAL_Y1, GRAPHITY_WIDTH - 1, GOAL_Y1);
                g.drawLine(0, GOAL_Y2, GRAPHITY_WIDTH - 1, GOAL_Y2);
                if (!ROUND_STARTED) {
                    g.drawImage(ballImage,
                            (GRAPHITY_WIDTH - BALL_SIZE) / 2 - 20,
                            (GRAPHITY_HEIGHT - BALL_SIZE) / 2,
                            BALL_SIZE, BALL_SIZE, this);
                }
            }
        }
        if (c != null) {
