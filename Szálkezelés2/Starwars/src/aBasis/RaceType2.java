...
import static aBasis.Global.RACER_GAPTIME_MSEC;
 ...
 * @author b6dmin
 */
public class RaceType2 extends Thread {

    private final List<SpriteObject> list;
    private final Control c;

    private final ExecutorService es;

    public RaceType2(List<SpriteObject> list, Control c) {
        this.list = list;
        this.c = c;
    ...
    public void run() {
        ...
        for (int ii = 0; ii < list.size(); ii++) {
            ...
            sleepThread(RACER_GAPTIME_MSEC);
        }
        es.shutdown();
