...
public final class Global {
    ...
    public static final int HEIGHT_1_TYPE = 540;
    public static final int HEIGHT_2_TYPE = 200;
    public static final int HEIGHT_PATH = 150;

    public static final long RACER_STEPTIME_MSEC = 16;
    public static final int RACER_STEP = 1;
    public static final long RACER_GAPTIME_MSEC = 2500;
}
